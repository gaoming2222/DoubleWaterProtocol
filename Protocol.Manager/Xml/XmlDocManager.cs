...
namespace Protocol.Manager
{
        ...
        public bool ResetComOrPortConfig(List<CPortProtocolConfig> listComs, bool bIsCom = true)
        {
            ...
            foreach (CPortProtocolConfig config in listComs)
            {
                if (mapProtocolName.ContainsKey(config.ProtocolDataName))
                {
                    ...
                    {
                        mapProtocolName[config.ProtocolDataName].ListPort.Add(new CXMLPort { PortNumber = config.PortNumber, BTcpOrUdp = config.BTcpOrUdp.Value, BAutoStart = config.BAutoStart.Value });
                    }
                ...
                else
                {
                    ...
                    {
                        mapProtocolName[config.ProtocolDataName].ListPort.Add(new CXMLPort { PortNumber = config.PortNumber, BTcpOrUdp = config.BTcpOrUdp.Value, BAutoStart = config.BAutoStart.Value, BStartOrNot = config.BStartOrNot.Value });
                    }
                }
                ...
                if (mapProtocolName.ContainsKey(config.ProtocolChannelName))
                {
                    ...
                    {
                        mapProtocolName[config.ProtocolChannelName].ListPort.Add(new CXMLPort { PortNumber = config.PortNumber, BTcpOrUdp = config.BTcpOrUdp.Value, BAutoStart = config.BAutoStart.Value, BStartOrNot = config.BStartOrNot.Value });
                    }
                }
                else
                {
    ...
    public class CPortProtocolConfig
    {
        ...
        /// 通讯协议名字
        /// </summary>
        public Nullable<bool> BTcpOrUdp { get; set; }
